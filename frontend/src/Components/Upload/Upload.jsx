...
//                 },
//                 body: JSON.stringify({ ...formData, email: email, projectId }), 
//             });
...
//                     <button className="upload-button upload-button-youtube" onClick={() => { setModalType('youtube'); setShowModal(true); }}>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(endpoint, {
                ...
                body: JSON.stringify({ ...formData, email, projectId }), 
            });
